// ============================================
// SHARED ICONS
// Centralized icon components used throughout the app
// ============================================
...
// BLACKBIRD LOGO
// ============================================
export function BlackbirdLogo({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 200 100" className={className}>
      <path 
        d="M100 15 C60 15, 20 40, 5 60 C20 55, 40 50, 60 55 C50 65, 45 75, 45 85 C55 80, 70 78, 85 80 L100 90 L115 80 C130 78, 145 80, 155 85 C155 75, 150 65, 140 55 C160 50, 180 55, 195 60 C180 40, 140 15, 100 15Z" 
        fill="currentColor"
      />
      <text x="100" y="58" textAnchor="middle" fontSize="16" fontWeight="bold" fontFamily="system-ui" fill="#1c1917">
        BLACKBIRD
      </text>
    </svg>
  );
